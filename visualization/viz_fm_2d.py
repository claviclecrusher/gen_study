"""
Visualization for Flow Matching model in 2D
"""
import numpy as np
...
def visualize_fm_2d(trajectories, x_data, save_path=None, epoch=None, cfm_type=None):
    """
    Visualize Flow Matching model in 2D with trajectories
    ...
    title = f'Flow Matching{cfm_str} (Epoch {epoch})' if epoch is not None else f'Flow Matching{cfm_str}'
    ax.set_title(title)
    ...
    if save_path:
        ...
        if epoch is not None:
            ...
            print(f"Flow Matching 2D visualization saved to {save_path}")

    return fig, ax


if __name__ == '__main__':
    print("Testing Flow Matching 2D visualization...")
    ...
    visualize_fm_2d(
        ...
        x_data=x_data,
        save_path='/home/user/Desktop/Gen_Study/outputs/test_viz_fm_2d.png',
        epoch=1
    )
    print("Test complete!")
